  ...
  return (
    <footer className="bg-[#143447] text-white py-10 px-6 md:px-20">
      <div className="grid md:grid-cols-4 sm:grid-cols-2 gap-10">
        {/* Hotel Info */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-[#f8de71]">Hotel Grand VadhuVar</h2>
          <p className="text-sm mb-4">
            Experience luxury and comfort at Hotel Grand VadhuVar Hotel. Located in the heart of the city, we offer world-class service with a personal touch.
          </p>
    ...
    <p className="text-white mt-1">
      ...
      NTR District, Andhra Pradesh - <span className="text-[#f8de71] font-medium">521175</span>
        ...
        <div>
          ...
          <a href="/" className="bg-[#f8de71] text-[#143447] px-5 py-2 rounded-tl-2xl rounded-br-2xl font-bold hover:bg-yellow-300 transition">
            Book a Room
          </a>
        </div>
      </div>
      ...
      <div className="border-t border-gray-600 mt-10 pt-4 text-sm text-center">
        &copy; {new Date().getFullYear()} Hotel Grand VadhuVar Hotel. All rights reserved.
      </div>
    </footer>
  );
};
