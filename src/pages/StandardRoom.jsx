...
const HotelListing = () => {
  ...
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
    <h1 className="text-3xl font-semibold text-gray-800">Standard Rooms</h1>
    <p className="text-gray-600 sm:max-w-xl">
      Standard Rooms offer comfortable, no-frills accommodation with essential amenities like a bed, private bathroom, TV, and Wi-Fi. They are ideal for budget-conscious travelers seeking a clean and convenient stay. Available in various types such as single, double, or twin configurations.
    </p>
  </div>
</div>
